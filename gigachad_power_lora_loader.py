...
NODE_NAME = 'Gigachad Power Lora Loader'
...
class GigachadPowerLoraLoader:
    """
    The Gigachad Power Lora Loader is a powerful, flexible node
...
NODE_CLASS_MAPPINGS = {
    "GigachadPowerLoraLoader": GigachadPowerLoraLoader,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GigachadPowerLoraLoader": "Gigachad Power Lora Loader",
}

...
NODE_NAME = "Gigachad CLIP Loader"
    ...
    for base in custom_dirs:
        ...
        for dirname in os.listdir(base):
            ...
            if not os.path.isfile(nodes_py):
                continue
            mod_name = "_gigachad_gguf_nodes_clip"
...
NODE_CLASS_MAPPINGS = {
    "GigachadCLIPLoader": GigachadCLIPLoader,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GigachadCLIPLoader": "Gigachad CLIP Loader",
}

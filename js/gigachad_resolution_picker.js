...
const NODE_TYPE = "GigachadResolutionPicker";

app.registerExtension({
    name: "Gigachad.ResolutionPicker",
    ...
    async beforeRegisterNodeDef(nodeType, nodeData) {
        ...
        nodeType.prototype.onNodeCreated = function () {
            ...
            this.title = "⚡ Gigachad Resolution Picker";
        };
        ...
        nodeType.prototype.onDrawForeground = function (ctx) {
            ...
            const width  = w("width")?.value  ?? 1024;
            const height = w("height")?.value ?? 1024;
            ...
            // Resolution display
            const resText = `${width} × ${height}`;
            ctx.font = `bold ${Math.min(18, W / resText.length * 1.1)}px monospace`;
            ctx.textAlign = "center"; ctx.textBaseline = "middle";
            ctx.fillStyle = GOLD.core; ctx.shadowColor = GOLD.core; ctx.shadowBlur = 10 + pulse * 8;
            ctx.fillText(resText, W / 2, this.size[1] - 14);

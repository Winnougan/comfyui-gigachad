...
NODE_NAME = "Gigachad Checkpoint Loader"
...
# GigachadModelLoader already does — is to attach the patch to the model
...
def _build_sage_func():
    ...
    Mirrors the "auto" branch of GigachadModelLoader._build_sage_func.
    """
    try:
...
class GigachadCheckpointLoader:
    NAME     = NODE_NAME
    CATEGORY = "Gigachad"
...
NODE_CLASS_MAPPINGS = {
    "GigachadCheckpointLoader": GigachadCheckpointLoader,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GigachadCheckpointLoader": "Gigachad Checkpoint Loader",
}

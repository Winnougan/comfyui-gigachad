...
NODE_NAME = "Gigachad LTX Resolution Picker"


class GigachadLTXResolutionPicker:
...
NODE_CLASS_MAPPINGS = {
    "GigachadLTXResolutionPicker": GigachadLTXResolutionPicker,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GigachadLTXResolutionPicker": "Gigachad LTX Resolution Picker",
}

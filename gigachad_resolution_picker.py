...
NODE_NAME = "Gigachad Resolution Picker"


class GigachadResolutionPicker:
    ...
    def pick_resolution(self, width=1024, height=1024, batch_size=1):
        import logging
        logging.getLogger("Gigachad").info(
...
NODE_CLASS_MAPPINGS = {
    "GigachadResolutionPicker": GigachadResolutionPicker,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GigachadResolutionPicker": "Gigachad Resolution Picker",
}

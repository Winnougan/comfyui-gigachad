...
class GigachadKSampler:
    ...
    def sample(
        ...
        try:
            ...
            # Older ComfyUI doesn't accept the third argument
            latent_image_ = comfy.sample.fix_empty_latent_channels(model, latent_image_)
...
NODE_CLASS_MAPPINGS = {
    "GigachadKSampler": GigachadKSampler,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GigachadKSampler": "Gigachad KSampler",
}

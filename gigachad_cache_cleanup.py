...
NODE_NAME = "Gigachad Cache Cleanup"


class GigachadCacheCleanup:
    NAME     = NODE_NAME
    CATEGORY = "Gigachad"
...
NODE_CLASS_MAPPINGS = {
    "GigachadCacheCleanup": GigachadCacheCleanup,
}

NODE_DISPLAY_NAME_MAPPINGS = {
    "GigachadCacheCleanup": "Gigachad Cache Cleanup",
}
